...
I was not loved.
It meant I loved.""",
    "prompt": "In this poem, Glück remembers childhood pain and connects it to love—a confusing mix where hurt feels like both proof of love and proof of its absence. The poem doesn’t solve this contradiction; it just sits with it. \nPrompt: Write a poem about a moment when love, family, or closeness carried conflicting meanings for you. Let the contradiction stay unresolved. Put both truths on the page without trying to make them fit together."
}
...
The Prompt should be appropriate for what you'd imagine a creative writing teacher would give. But keep your language straightforward, concise, and free from flowery language. For example: 
